...
public class Inversions {
    ...
    public static void main(String[] args) throws IOException {
        Student[] students = new Student[] {
            new Student("231230001", "Nguyễn Văn A"),
            new Student("231230003", "Trần Văn C"),
            new Student("231230002", "Lê Thị B"),
            new Student("231230005", "Đinh Văn E"),
            new Student("231230004", "Phạm Văn D"),
            new Student("231230007", "Lý Văn G"),
            new Student("231230006", "Ngô Văn F"),
            new Student("231230010", "Vũ Thị J"),
            new Student("231230008", "Hồ Văn H"),
            new Student("231230009", "Đoàn Văn I")
        };    
        System.out.println("Inversions in Student[] students: " + Inversions.count(students));
    }
}